...
class TabsSettingsFragment : PreferenceFragmentCompat() {
    ...
    private lateinit var ramSaverMode: SwitchPreference
    ...
    private fun setupPreferences() {
        ...
        ramSaverMode = requirePreference<SwitchPreference>(R.string.pref_key_ram_saver_mode).also {
            it.isChecked = requireContext().settings().ramSaverModeEnabled
            it.onPreferenceChangeListener = SharedPreferenceUpdater()
        }
