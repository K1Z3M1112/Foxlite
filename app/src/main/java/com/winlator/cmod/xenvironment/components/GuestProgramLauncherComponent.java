...
public class GuestProgramLauncherComponent extends EnvironmentComponent {
    ...
    private int execGuestProgram() {
        ...
        Log.i("GuestProgramLauncherComponent", "[LSFG_DIAG] final exec command=\"" + command + "\""
                + " DISABLE_LSFG=" + execEnvVars.get("DISABLE_LSFG")
                + " LSFG_PROCESS=" + execEnvVars.get("LSFG_PROCESS")
                + " LSFG_DLL_PATH_UNIX=" + execEnvVars.get("LSFG_DLL_PATH_UNIX")
                + " LSFG_MULTIPLIER=" + execEnvVars.get("LSFG_MULTIPLIER")
                + " VK_LAYER_PATH=" + execEnvVars.get("VK_LAYER_PATH"));
